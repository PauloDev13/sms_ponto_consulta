...
def main():
    ...
    st.session_state.is_submit_disabled = (username_valid and password_valid)
    # Botão de submissão
    st.button('Submit', disabled=st.session_state.is_submit_disabled, on_click=validate_and_submit)
